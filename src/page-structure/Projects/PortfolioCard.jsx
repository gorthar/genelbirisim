...
export default function PortfolioCard({ project }) {
  return (
    <div className="project-item p-4 w-[380px] sm:w-[460px] h-[690px] sm:h-[750px] bg-green-200 bg-opacity-80 border-b-2 rounded-lg shadow-lg border-green-600 mt-10 py-2">
